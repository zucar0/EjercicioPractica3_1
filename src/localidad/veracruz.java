...
public class veracruz {
    ...
    //Constructor
    public veracruz(String clave, String turno, String centroEducativo, String domicilio, int numExterior, int codigoPostal, int lada, int telefono, int docentesMujeres, int docentesHombres, int alumnosMujeres, int alumnosHombres){
        this.clave=clave;
        this.turno=turno;
